...
<ul class="nav">
	...
	<li><a href="4(competencyd3).jsp"><font class="sidebartext"
		size="+1" face="Times New Roman, Times, serif">Deparment3</font></a></li>
	<li>
	<div class="usedpage"><font class="sidebartext" size="+1"
		face="Times New Roman, Times, serif">Deparment4</font></div>
	</li>
...
<div class="content">
<center>
<%int i=4; session.setAttribute("dept_comp",i); %> <%String name_of_jsp= "temp.jsp"; %>
...
<div class="footer"><img src="stylesheets,scripts,images/images/CodePassion_sm.gif" alt=""
	width="250" height="70" /></div>
