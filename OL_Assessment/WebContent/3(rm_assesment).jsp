...
<title>Review Manager Assessment</title>
...
<link rel="stylesheet" href="stylesheets,scripts,images/rm_assesment.css" />
...
<i><%= rb.getString("Employee_answers_are_in")%><font
	color="#666666">Grey</font><br /><%= rb.getString("Supervisor_answers_are_in")%><font
	color="#FF0000">Red</font></i> <br />
<br />
...
out.println("<tr><td align=center colspan=1 class=empanswer>Employee Answer:"+session.getAttribute("empq"+i)+"</td>&nbsp&nbsp&nbsp&nbsp<td align=center colspan=1 class=empanswer>Supervisor Answer:"+session.getAttribute("supq"+i)+"</td>");
